...
/**
 * Created by sotra on 10/27/2017.
 */
...
public class Config {
    ...
    public static String UPDATE_USER_PROFILE = "update_user_profile_slider" ;

    public static String temp_imge = "http://197.44.62.106/B2B/upload/dump/d1ef632c96139711ff9728f096abb2c4.jpg;";
}
